...
**UNVERIFIED against real book material** — built without sample book pages to match against (unlike `/summarize`, which was built from 4 real Evernote samples). Treat first outputs as a rough draft to review against actual book style, not production-ready.
